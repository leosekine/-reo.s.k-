...
const MENU_ITEMS: readonly {
  ...
  { id: 'shifts', path: '/shifts', label: 'シフト申請', description: 'シフト希望の提出' },
  { id: 'calendar', path: '/calendar', label: 'カレンダー', description: '月間勤務一覧' },
  { id: 'report', path: '/report', label: '日報', description: '業務内容の記録' },
  { id: 'dashboard', path: '/dashboard', label: 'ダッシュボード', description: 'チーム全体の管理' },
]
...
export default function AppLayout({
  ...
  return (
    <div className="flex h-screen bg-gray-50">
      {/* サイドバー */}
      <aside
        className={`flex shrink-0 flex-col bg-[#1e293b] transition-all duration-300 ${
